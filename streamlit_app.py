...
# Header
st.header('End Times Timeline - This is a prototype under development', divider='violet')
st.text("This should be viewed from a desktop or tablet screen. Use the buttons at the lower left of the timeline or click and drag to navigate to specific events or use the navigation buttons overlayed to view events in chronological order.")
...
st.header('Additional Resources', divider='blue')